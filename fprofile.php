...
<meta name="author" content="e-Army @ RGUKT-N" />
		...
		<link rel="shortcut icon" href="facassets/images/rgu.ico">
...
<form method=post enctype="multipart/form-data" action=fprofile.php onsubmit="return confirm('Do you want to Submit');">
 ...
 <fieldset>
			...
			if(status==4)
			{
			$("#msg2").html(" <p style='font-weight:bold;'><i class='fa fa-thumbs-up'></i>&nbsp;Ok,You can use it");
			}
			else if(status==5)
			{
...
<?php
   ...
   die("Url Not available");
	...
	{
	echo "<script>loadall('Please fill all the fields');</script>";
	}
}
else{
